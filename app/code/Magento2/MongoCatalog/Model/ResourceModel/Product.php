...
class Product extends \Magento\Catalog\Model\ResourceModel\Product
{
    ...
    public function load($object, $entityId, $attributes = [])
    {
        ...
        $tableName = PatchData::BACKEND_TABLE_NAME;
        if (isset($this->_attributesByTable[$tableName])) {
            $attributeCodeList = array_keys($this->_attributesByTable[$tableName]);
            unset($this->_attributesByTable[$tableName]);
